            ...
            <div className="flex items-end justify-between gap-1 min-h-[128px] w-full pt-12 overflow-x-auto no-scrollbar pb-2">
              {dailyStats.map((d, i) => (
                <div
                  ...
                  */
                  className="flex-none w-[calc(100%/40)] min-w-[24px] flex flex-col items-center gap-2 group relative justify-end"
                >
                  {/* バーのラッパー */}
                  <div
                    className="w-full max-w-[18px] flex flex-col-reverse justify-start transition-all duration-500"
                    style={{
